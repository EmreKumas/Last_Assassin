...
public class GroundLeftUpper extends GroundForEverything implements AirThings{

    public GroundLeftUpper(Background background, int screenWidth, int screenHeight){
    ...
    public void draw(Canvas canvas){
        ...
        ground.moveTo((int) (330  * widthRatio), (int) (-400 * heightRatio));
        ground.lineTo((int) (330  * widthRatio), (int) (-500 * heightRatio));
        ground.lineTo((int) (870  * widthRatio), (int) (-500 * heightRatio));
        ground.lineTo((int) (870  * widthRatio), (int) (-400 * heightRatio));
        ground.lineTo((int) (330  * widthRatio), (int) (-400 * heightRatio));
        ground.close();
