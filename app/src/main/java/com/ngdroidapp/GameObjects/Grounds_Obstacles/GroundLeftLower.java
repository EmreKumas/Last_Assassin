...
public class GroundLeftLower extends GroundForEverything implements AirThings{

    public GroundLeftLower(Background background, int screenWidth, int screenHeight){
    ...
    public void draw(Canvas canvas){
        ...
        ground.moveTo((int) (0  * widthRatio), (int) (50 * heightRatio));
        ground.lineTo((int) (0  * widthRatio), (int) (-40 * heightRatio));
        ground.lineTo((int) (1270  * widthRatio), (int) (-40 * heightRatio));
        ground.lineTo((int) (1270  * widthRatio), (int) (50 * heightRatio));
        ground.lineTo((int) (0  * widthRatio), (int) (50 * heightRatio));
        ground.close();
