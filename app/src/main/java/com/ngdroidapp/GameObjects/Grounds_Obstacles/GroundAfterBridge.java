...
public class GroundAfterBridge extends GroundForEverything{
    ...
    public void draw(Canvas canvas){
        ...
        ground.moveTo((int) (2360  * widthRatio), (int) (210 * heightRatio));
        ground.lineTo((int) (2360 * widthRatio), (int) (70 * heightRatio));
        ground.lineTo((int) (3200 * widthRatio), (int) (70 * heightRatio));
        ground.lineTo((int) (3200 * widthRatio), (int) (210 * heightRatio));
        ground.lineTo((int) (2360  * widthRatio), (int) (210 * heightRatio));
        ground.close();
